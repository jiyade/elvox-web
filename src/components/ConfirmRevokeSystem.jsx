...
const ConfirmRevokeSystem = ({
    ...
    return (
        ...
        >
          ...
          max-h-[90vh] min-h-0 flex flex-col gap-4 overflow-hidden
        '
            >
                <div className='border-b border-gray-500 w-full pb-2 pt-1'>
                    <h2 className='text-lg text-center'>
                        Revoke System - [{systemName}]?
                    </h2>
                </div>
                <div className='text-center text-sm'>
                    <p>
                        Revoking access will immediately disable this system and
...
export default ConfirmRevokeSystem
