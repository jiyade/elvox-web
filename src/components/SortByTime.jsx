        ...
        >
            ...
            >
                ...
                <ListboxOptions className='flex flex-col border border-gray-500 focus:outline-none text-sm absolute w-full top-10 left-0 z-10 bg-bg-light dark:bg-bg-dark rounded-md'>
                    <ListboxOption
                        value='latest'
                        className='group grid grid-cols-[auto_1fr] items-center gap-2 px-3 py-2 cursor-pointer text-primary-light dark:text-primary-dark hover:text-primary-dark hover:bg-accent truncate rounded-sm [word-break:break-word]'
                    >
                        <span>Latest</span>
